...
<required_reading>
Read `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
