...
**Verification depth scales with `asvs_level`** (see @/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
