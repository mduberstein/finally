...
`codex exec "Please review the file planning/PLAN.md and write your feedback to planning/REVIEW_BY_CODEX_AGENT.md. Do not review any implementation or code files - only review the planning/PLAN.md file."`
