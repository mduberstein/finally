...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/.gsd-surface.json`
(sibling to `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/skills`).
...
`/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/.gsd-profile`
Skill dirs: `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/skills/gsd-*/`
Engine module: `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
