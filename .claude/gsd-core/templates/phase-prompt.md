...
<!-- For checkpoint task examples and patterns, see @/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
