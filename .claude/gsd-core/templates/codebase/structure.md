...
- Usage: Reference from command with `@/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
