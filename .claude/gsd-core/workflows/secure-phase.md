...
```
Agent(
  prompt="Read /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/templates/SECURITY.md`
