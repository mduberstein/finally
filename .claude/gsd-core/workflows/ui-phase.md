...
```markdown
Read /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/agents/gsd-ui-checker.md for instructions.
...
@/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
