...
ones). Reference: @/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/templates/spec.md.
