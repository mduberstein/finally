...
`@/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
