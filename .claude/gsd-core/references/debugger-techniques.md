...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude
                  → checks /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core
                  → writes to /Users/mdub/SOFT-DEV/GitHubRepos/AIProjects/finally/.claude/gsd-core/hooks/
