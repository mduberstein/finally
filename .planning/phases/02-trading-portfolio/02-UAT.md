...
updated: 2026-08-16T06:20:00.000Z
---

## Current Test

number: 1
name: Backend-disconnect resilience
expected: |
  Header never flashes to $0.00 or blank on a dropped connection; last-good
  cash/total-value figures persist; the connection dot goes red then back to
  green automatically once the backend returns.
