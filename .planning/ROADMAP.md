...
- [x] 03-02-PLAN.md — Frontend tracer: inline add form, per-row remove control, and a sparkline growing in every row

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-03-PLAN.md — Portfolio value over time: post-trade and 30s snapshots, history endpoint, P&L chart

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 03-04-PLAN.md — Portfolio heatmap sized by weight and coloured by P&L, plus the click-to-select main chart
...
- [x] 04-02-PLAN.md — The live AI Copilot panel: restored history, bubble transcript, typing dots, pinned input
- [x] 04-03-PLAN.md — Portfolio-aware prompt and auto-executed trades and watchlist changes with exact-numbers refusals

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-04-PLAN.md — Action cards in the transcript and a terminal that refreshes after a chat-driven change
